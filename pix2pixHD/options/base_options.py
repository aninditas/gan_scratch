...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='data/8_output_checkpoint_training', help='models are saved here')
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='data/6_input_straight')
