...
def save_class_activation_images(org_img, target_class, activation_map, file_name):
    """
    ...
    path_to_file = file_name + '_{}.png'.format(str(target_class))
...
def apply_colormap_on_image(org_im, activation, colormap_name):
    ...
    heatmap = heatmap.resize((320, 240))
