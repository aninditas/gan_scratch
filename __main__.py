...
if __name__ == '__main__':
    ...
    if 5 in steps:
        ...
        os.system('cmd /c "python pix2pixHD/train.py --name straight --dataroot data/7_output_scratch_basic_unit_for_gen_train/data_4/straight --niter 1 --niter_decay 1"')
        os.system('cmd /c "python pix2pixHD/train.py --name curve --dataroot data/7_output_scratch_basic_unit_for_gen_train/data_4/curve --niter 1 --niter_decay 1"')
        os.system('cmd /c "python pix2pixHD/train.py --name end --dataroot data/7_output_scratch_basic_unit_for_gen_train/data_4/end  --niter 1 --niter_decay 1"')

    if 6 in steps:
        print('STEP 6: GENERATOR INFERENCE')
        os.system('cmd /c "python pix2pixHD/test.py --name straight --dataroot data/3_output_scratch_basic_unit_for_inference/straight"')
        os.system('cmd /c "python pix2pixHD/test.py --name curve --dataroot data/3_output_scratch_basic_unit_for_inference/curve"')
        os.system('cmd /c "python pix2pixHD/test.py --name end --dataroot data/3_output_scratch_basic_unit_for_inference/end"')
